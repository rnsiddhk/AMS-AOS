...
public class NMapViewer extends NMapActivity {
	...
	private static final String CLIENT_ID = "iVXCd14sUhHd0RaP1GrR";
...
//		}
		...
		// 상단 타이틀바
//		((TextView)(((View)findViewById(R.id.top)).findViewById(R.id.txt_title))).setText("지도 보기");
	}
